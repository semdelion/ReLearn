...
namespace ReLearn.API
{
    public static class Statistics
    {
        ...
        public static async Task Add(List<DBWords> WordDatabase, int CurrentWordNumber, int answer)
        {
            ...
            await DBWords.Update(WordDatabase[CurrentWordNumber].Word, value);
        }
        public static async Task Add(List<DBImages> ImagesDatabase, int CurrentWordNumber, int answer)
        {
            ...
            await DBImages.Update(ImagesDatabase[CurrentWordNumber].Image_name , value);
        }
