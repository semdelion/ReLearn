...
/** @hide */
	...
	static {
		__md_methods = 
			"n_Button_Languages_Click:(Landroid/view/View;)V:__export__\n" +
			"n_Button_Images_Click:(Landroid/view/View;)V:__export__\n" +
	...
	public void Button_Languages_Click (android.view.View p0)
	{
		n_Button_Languages_Click (p0);
	}

	private native void n_Button_Languages_Click (android.view.View p0);


	public void Button_Images_Click (android.view.View p0)
	{
		n_Button_Images_Click (p0);
	}

	private native void n_Button_Images_Click (android.view.View p0);
