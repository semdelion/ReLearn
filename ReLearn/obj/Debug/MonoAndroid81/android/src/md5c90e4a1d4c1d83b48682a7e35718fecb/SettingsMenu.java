...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ReLearn.SettingsMenu, ReLearn", SettingsMenu.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SettingsMenu.class)
			mono.android.TypeManager.Activate ("ReLearn.SettingsMenu, ReLearn", "", this, new java.lang.Object[] {  });
	}
