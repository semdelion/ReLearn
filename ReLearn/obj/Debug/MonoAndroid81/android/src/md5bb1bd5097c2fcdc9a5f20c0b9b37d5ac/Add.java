...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ReLearn.Languages.Add, ReLearn", Add.class, __md_methods);
	}
	...
	public Add ()
	{
		...
		if (getClass () == Add.class)
			mono.android.TypeManager.Activate ("ReLearn.Languages.Add, ReLearn", "", this, new java.lang.Object[] {  });
	}
