...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ReLearn.Languages.Repeat, ReLearn", Repeat.class, __md_methods);
	}
	...
	public Repeat ()
	{
		...
		if (getClass () == Repeat.class)
			mono.android.TypeManager.Activate ("ReLearn.Languages.Repeat, ReLearn", "", this, new java.lang.Object[] {  });
	}
