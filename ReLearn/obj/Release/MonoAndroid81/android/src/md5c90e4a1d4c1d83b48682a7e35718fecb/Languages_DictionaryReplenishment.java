...
public class Languages_DictionaryReplenishment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ReLearn.Languages_DictionaryReplenishment, ReLearn", Languages_DictionaryReplenishment.class, __md_methods);
	}


	public Languages_DictionaryReplenishment ()
	{
		super ();
		if (getClass () == Languages_DictionaryReplenishment.class)
			mono.android.TypeManager.Activate ("ReLearn.Languages_DictionaryReplenishment, ReLearn", "", this, new java.lang.Object[] {  });
	}
