...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ReLearn.Languages_Stat, ReLearn", Languages_Stat.class, __md_methods);
	}


	public Languages_Stat ()
	{
		super ();
		if (getClass () == Languages_Stat.class)
			mono.android.TypeManager.Activate ("ReLearn.Languages_Stat, ReLearn", "", this, new java.lang.Object[] {  });
	}
