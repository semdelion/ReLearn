...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ReLearn.Languages, ReLearn", Languages.class, __md_methods);
	}
	...
	public Languages ()
	{
		...
		if (getClass () == Languages.class)
			mono.android.TypeManager.Activate ("ReLearn.Languages, ReLearn", "", this, new java.lang.Object[] {  });
	}
