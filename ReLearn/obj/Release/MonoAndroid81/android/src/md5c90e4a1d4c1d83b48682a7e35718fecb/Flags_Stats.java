...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ReLearn.Flags_Stats, ReLearn", Flags_Stats.class, __md_methods);
	}
	...
	public Flags_Stats ()
	{
		...
		if (getClass () == Flags_Stats.class)
			mono.android.TypeManager.Activate ("ReLearn.Flags_Stats, ReLearn", "", this, new java.lang.Object[] {  });
	}
